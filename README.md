...
Exemplatory schema plugin for testing ELNs
...
```sh
git clone https://github.com/Sideboard/nomad-eln-mirage.git
cd nomad-eln-mirage
...
| Name | E-mail     |
|------|------------|
| Sascha Klawohn | [sascha.klawohn@physik.hu-berlin.de](mailto:sascha.klawohn@physik.hu-berlin.de)
